	...
	<div class="container col-md-8">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Enter Temporary Number issued:-</label> <input type="text"
				...
				<fieldset class="form-group">
					<label>Select Amount (Tax + Registration Amount) :- </label> 
					<select name="amount" id="amount">
					  <option value="none" selected disabled hidden> Select amount </option>
					    <option value="10000">Two, Three Wheeler : Rs. 10000</option>
					    <option value="80000">Four Wheeler : Rs. 80000</option>
					  </select>
				</fieldset>
					...
					Image Upload new form
					 <form action="<%= request.getContextPath() %>/FileUpload id=<>" method="post" enctype="multipart/form-data">
